...
int main()
{
    ...
    case 1:
        ...
        printf("這是一個富有男子氣概的數字，并暗示著這個人是個天生的領袖。你一直覺得假如你不能得到至高的權力就不能滿足于現狀，所以掌控你的事業吧！一個選擇是成為一名不考慮學位的自由職業者——新聞、平面設計和網頁開發會提供這樣的職位。相反地，你勇敢的性格會使得你在某些具有“攻擊性”的領域獲得成功，比如律法，又或者是工程學這樣極其需要韌性的領域！\n");
        break;
    case 2:
        printf("(成全)	敏感、體貼、柔順、和諧、依賴\n");
        printf("優點：個性內斂，善於分工合作，重視群體關係，喜歡受到別人肯定\n");
        printf("缺點：情緒不定、優柔寡斷、難以捉摸、膚淺不安。容易因他人的意見而受到影響，不能忍耐孤獨\n");
        printf("在命理中，2是個陰柔的數字。作為生命靈數來說，它暗示著你擁有極大的能量去克服重重障礙。你天生就比別人更適合做那種不僅需要努力工作，而且還得憑借直覺的事情。假如這份苦差事還有著高回報，那就更好了！你擅長的工作領域包括教育、醫藥以及心理學，由于這些領域的工作不僅需要靈數2的耐心，而且還需要你教書育人的特質。\n");
        break;
    case 3:
        printf("(創意)	行動、樂觀、自信、表現、社交\n");
        printf("優點：聰明機警，有創意，多具有藝術天份，表達能力強	欺瞞、虛榮浮華、憤世嫉俗、渙散不集中\n");
        printf("缺點：。任性，多只依自己的喜好行事，容易好高騭遠\n");
        printf("這是一個極具創造力的數字，同時也是個不按常理出牌的家伙！記住，你永遠都不會滿足于那種朝九晚五式的都市生活，由于你是個生性勇敢的人。（靈數3不喜歡穩定的工作）不要害怕去學那種傳統意義上“沒市場”的專業，假如你對電影感興趣或者你才思靈敏，你就有可能像你的那些學醫的朋友一樣成功。媒體藝術（比如電視、公益事業或者廣告）是個不錯的選擇，但你熱情的天性也會使你在生物學、心理學以及心理治療方面有所建樹。\n");
        break;
    case 4:
        printf("(務實)	忠誠、次序、效率、助人、自律\n");
        printf("優點：組織能力強，做事條理分明，目光敏銳，能迅速掌握重點\n");
        printf("缺點：獨斷獨行、心胸狹窄、容易緊張、不易妥協。固執，缺乏安全感，不敢承擔風險，因此容易讓機會溜走\n");
        printf("不要由于你喜歡有規律的模式而覺得自己死板。你有著不可思議的職業道德，并且腳踏實地勤奮的工作。你更適合那些需要集中留意力和有條款約束的領域，比如運動員或者建筑師。同時，你也能輕易地得到優秀的組織能力，所以學習貿易或者金融治理也能讓你很快獲得成功。\n");
        break;
    case 5:
        printf("(自由)	聰穎、冒險、適應強、多變化、學習快\n");
        printf("優點：能答善辯，口才極佳，熱情豪爽，講義氣，崇尚自由\n");
        printf("缺點：博而不精、持續力差、毫不在乎、索求無度。不喜歡受到束縛，容易放縱，容易得罪別人\n");
        printf("做個5號人可不太輕松捏，你適應性極強，思維前瞻，說實話你能勝任任何工作。多關注那些最能讓你感覺幸，多參加團體活動，少劃地為牢（打個比方）。你對公共關系或亟需創造力的廣告事業的悟性超群，而且還喜歡時不時地冒冒風險，所以，你有自主創業的本事（點子咨詢）。事實還真挺夸姣，許多5號靈數的人是消防隊員或特技演員，你可是稀有、勇猛的人種！\n");
        break;
    case 6:
        printf("(責任)	穩定、信賴、熱情、正義、奉獻\n");
        printf("優點：情感細膩，擅長人際間的交際，喜歡幫助他人，重承諾與責任\n");
        printf("缺點：缺乏自信、不切實際、好強爭辯、強行干涉。不理智時，常會做出錯誤的決定，付出不求回報時容易讓自己受傷\n");
        printf("首先，6是一個社會數字，所以不管你想從事什么工作或者產業，它最好和“與人溝通，與人交流“相關。你尤其容易被醫學所吸引，并且由于6這個數字使得你會承諾或者傾向去堅守一份工作，你最好早一點將自己投身于你的研究之中。你可能會想要通過輔修整體醫學或者推拿，來充實你對于生物或者醫學的研究，，另外，你還可以選擇城市規劃，或者風景設計。不管你選擇怎樣的路徑，它應該包括為了對他人的博愛而工作。\n");
        break;
    case 7:
        printf("(探究)	內省、沉默、直覺、真理、理想\n");
        printf("優點：擅長鑽研事物，喜歡追求真理，精於算計，遇事理智\n");
        printf("缺點：冷漠、自大傲慢、自我放縱、鬼鬼祟祟。處事不夠圓滑，不容易被討好，容易到手的東西不會珍惜\n");
        printf("這個數字暗示著你是一個實用主義的夢想家——你會讓你的思想天馬行空，直到想出真正有創意的解決辦法。由于你擁有一個能夠從智力/知性的角度來看待幻想的頭腦，理論科學非常適合你。你可以考慮學習物理，化學，數學和天文學，或是創造性地學習經濟學。你在藝術方面也很厲害，所以你也很適合學習那種高概念（high concept，指的是那種可以被一句簡潔的假定/條件所完全概括的藝術作品）的領域，譬如舞臺藝術或是現代舞。假如你對神學很感愛好，你可以考慮學習并成為某一宗教的領袖（或是類似的職位）。靈數為7的人通常可以輕松地在精神上和他人溝通（靈媒？）\n");
        break;
    case 8:
        printf("(權威)	忠貞、持續、堅定、誠懇、照料\n");
        printf("優點：喜歡冒險刺激，有商業頭腦，喜歡追求權力，能即知即行\n");
        printf("缺點：唯物主義、無道德感、心高氣傲、排除他議、驕傲。對喜歡的東西有異常的執著，面對衝突時會勉強自己\n");
        printf("這個數字意味著權威！擁有著靈數8的人們，天生就懂得貿易法則，而且對于一切規章軌制不僅很在行，也享受著介入制訂的過程。或許“公平/正義”，對你而言，就像閃閃發光一般吸引著你，因此不妨考慮報讀法律或者政治學。。與此同時，由于你總是更希望自己能生活在一個穩定的體系里面，所以當你面臨擇業時，也會不由自主的選擇大財/團體，并渴望通過自己不中斷的努力已經強烈的貿易道德，爬上權力的高峰。而你身上那種高度集中的留意力，同樣也會在外科醫生和心理學家身上體驗出來。\n");
        break;
    case 9:
        ...
        printf("你的關注焦點是在全人類身上，由于9就是關于匡助人類的數字。也許是通過研習大家的過去來匡助大家更好地理解未來（比如說考古學），也許是通過采取一條的科學的道路來匡助人類更好地認知現在（例如人類學、社會學相關領域）。由于你在改進人類境況方面有如此大的愛好，因此你在需要外交手段的職位上都會做得很好，比如說社會福利工作、教導、咨詢、仲裁等。假如你發現你被與這些領域截然不同的領域所吸引，確保你以后能將你所學的東西運用到某個自愿者組織里，比如說和平組織、無國界醫生組織等等。\n");
        break;
    }
