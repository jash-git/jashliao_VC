========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : client
========================================================================


AppWizard has created this client application for you.  This application
...
clientDlg.h, clientDlg.cpp - the dialog
    ...
    template is in client.rc, which can be edited in Microsoft
	Visual C++.
