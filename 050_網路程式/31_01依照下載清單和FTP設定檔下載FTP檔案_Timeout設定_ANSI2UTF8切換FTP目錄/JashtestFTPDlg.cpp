...
void CJashtestFTPDlg::OnButton1() 
{
	...
	m_pInetSession->SetOption(INTERNET_OPTION_CONNECT_TIMEOUT,1000*2);
	m_pInetSession->SetOption(INTERNET_OPTION_DATA_RECEIVE_TIMEOUT, 1000*15);
	m_pInetSession->SetOption(INTERNET_OPTION_DATA_SEND_TIMEOUT, 1000*10);
