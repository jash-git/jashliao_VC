...
void CIE_COMDlg::GetSaveMyData(void)
{
	...
	CString StrWrite;
	StrWrite="<html><head><meta http-equiv=\"Content-Language\" content=\"zh-tw\"><meta http-equiv=\"Content-Type\" content=\"text/html; charset=big5\" /><title>無標題文件</title>";
	...
	fprintf(p1,"%s\n",StrWrite.GetBuffer(0));
	StrWrite="<table width=\"256\" height=\"663\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
	fprintf(p1,"%s\n",StrWrite.GetBuffer(0));
	//////////////////////////////////////////////
	fprintf(p1,"%s\n",StrHtmlData.GetBuffer(0));
	//////////////////////////////////////////////
	StrWrite="<table width=\"256\" height=\"663\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td width=\"64\" height=\"69\"></td><td width=\"182\" height=\"130\"></td></tr>";
	fprintf(p1,"%s\n",StrWrite.GetBuffer(0));
	////////////////////////////////////////////////////////////////////////
	StrWrite="<tr><td height=\"50\"></td><td height=\"85\" valign=\"top\"><b><font face=\"標楷體\" size=\"4\" color=\"#535353\">";
	StrWrite=StrWrite+StrData[0];
	StrWrite=StrWrite+"</font></b></td></tr>";
	fprintf(p1,"%s\n",StrWrite.GetBuffer(0));
	////////////////////////////////////////////////////////////////////////
	StrWrite="<tr><td height=\"76\"></td><td height=\"85\" valign=\"top\"><b><font face=\"標楷體\" size=\"4\" color=\"#535353\">";
	StrWrite=StrWrite+StrData[1];
	StrWrite=StrWrite+"</font></b></td></tr>";
	fprintf(p1,"%s\n",StrWrite.GetBuffer(0));
	////////////////////////////////////////////////////////////////////////
	StrWrite="<tr><td height=\"59\"></td><td height=\"85\" valign=\"top\"><b><font face=\"標楷體\" size=\"4\" color=\"#535353\">";
	StrWrite=StrWrite+StrData[2];
	StrWrite=StrWrite+"</font></b></td></tr>";
	fprintf(p1,"%s\n",StrWrite.GetBuffer(0));
	////////////////////////////////////////////////////////////
	StrWrite="<tr><td height=\"136\"></td><td valign=\"top\"><b><font face=\"標楷體\" size=\"4\" color=\"#535353\">";
...
void CIE_COMDlg::OnTimer(UINT nIDEvent) 
{
	...
	{
		ShellExecute(NULL,"open","Web.exe",NULL,NULL,SW_SHOWNORMAL);
		this->OnOK();
	}
	intHttpSiteCount++;	
