...
BOOL CMailMessage::EncodeHeader()
{
	...
	CTime TimeSend(m_tDateTime.GetYear(),m_tDateTime.GetMonth( ),m_tDateTime.GetDay( ),(m_tDateTime.GetHour( )-8),m_tDateTime.GetMinute( ),m_tDateTime.GetSecond( ));
	// Format: Mon, 01 Jun 98 01:10:30 GMT
	sDate = TimeSend.Format( "%a, %d %b %y %H:%M:%S %Z" );
