...
//*/
	...
	///////////////////////////////6_end
	*/
	if(intHttpSiteCount==intHttpSiteAll)
	{
		MessageBox("結束。");
		this->OnOK();
	}
...
void CIE_COMDlg::GetSaveMyData(void)
{
	...
	int intCount_d=0;
	p=fopen("text.txt","r");
	switch((intHttpSiteCount-1))
	{
		case 0:
			p1=fopen("text1.txt","w");
			break;
		case 1:
			p1=fopen("text2.txt","w");
			break;
		case 2:
			p1=fopen("text3.txt","w");
			break;
		case 3:
			p1=fopen("text4.txt","w");
			break;
		case 4:
			p1=fopen("text5.txt","w");
			break;
		case 5:
			p1=fopen("text6.txt","w");
			break;
		case 6:
			p1=fopen("text7.txt","w");
			break;
		case 7:
			p1=fopen("text8.txt","w");
			break;
		case 8:
			p1=fopen("text9.txt","w");
			break;
		case 9:
			p1=fopen("text10.txt","w");
			break;
	}
	CString data="";
	CString StrSave1="";
