...
void CJashtestFTPDlg::OnButton1() 
{
	...
	{ 
		...
		m_pFtpConnection=m_pInetSession->GetFtpConnection("192.168.11.98","jash","1234"); 
	} 
...
{
	// TODO: Add your control notification handler code here
  if(m_pFtpConnection->GetFile("美味關係_2.wmv","AV\\美味關係_2.wmv",true,FILE_ATTRIBUTE_NORMAL,FTP_TRANSFER_TYPE_BINARY,1))   
  {   
	  MessageBox("OK1111");
  }
  else
