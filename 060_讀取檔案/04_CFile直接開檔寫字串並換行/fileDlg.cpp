...
CFile file;
file.Open("my.txt",CFile::modeCreate | CFile::modeWrite);
char Data[] = "111111111";
file.SeekToBegin(); 
file.Write(Data,sizeof(Data)/sizeof(char));
char Data1[2]={13,10};
file.Write(Data1,sizeof(Data1)/sizeof(char));
char Data2[] = "2222222222";
file.Write(Data2,sizeof(Data2)/sizeof(char));
file.Close();	
