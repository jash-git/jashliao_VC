...
void CTest_Analyse_DataDlg::OnButton1() 
{
	...
	StrNetWorkDir="Y:\\Data\\";///----->因為只指到NabroClien
	...
	//////////////////////////////////
	CString StrInfoFileName="Y:\\Data\\Schedule\\";
	FILE *pinfo;
	/////////////////////////////////
	while(!pf.eof())
	//////////////////////////////01_end
	{
		...
		//////////////////////////////////////////////////////////
		CreatInfoFileHead();
		StrInfoFileName="Y:\\Data\\Schedule\\";
		...
		{ 
			...
			blnSearchFile=SearchFile(StrNetWorkDir,StrSearchFileName);//"Y:\\,StrSearchFileName"
			switch(fd.intaction)
			{
				case 0://Add
