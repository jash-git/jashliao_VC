...
void CNetWork_Browse_CopyDlg::OnButton1()//取得比對檔案數並紀錄檔名 
{
	...
	////////////////////
	*/
	//GetLocalFileAmount();----------------------------->由於要修改成直接全砍網路端的所有檔案，因此這的按鈕全部無效20080215
	//MessageBox("OK");
...
void CNetWork_Browse_CopyDlg::GetNetWorkFileAmount()
{

	StrSearchDrt=gStrDirValue+"\\";
	/////////////////////產生檔案
	pf=fopen("data.txt","w");
	BrowseDir(StrSearchDrt);
	fclose(pf);
