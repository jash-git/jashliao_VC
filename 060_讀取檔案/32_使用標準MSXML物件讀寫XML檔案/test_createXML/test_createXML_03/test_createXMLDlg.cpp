...
void CTest_createXMLDlg::OnButton1() 
{
	...
	xmlRoot->setAttribute("data",(const char *)"test");
...
void CTest_createXMLDlg::OnButton5()//新增節點 
{
	// TODO: Add your control notification handler code here
	MSXML2::IXMLDOMDocumentPtr pDoc;
	MSXML2::IXMLDOMElementPtr xmlRoot;
...
void CTest_createXMLDlg::OnButton6()//修改現有節點值 
{
	// TODO: Add your control notification handler code here
	MSXML2::IXMLDOMDocumentPtr pDoc;
	MSXML2::IXMLDOMElementPtr xmlRoot;
...
void CTest_createXMLDlg::OnButton7()//修改屬性 
{
	// TODO: Add your control notification handler code here
//FILE *fp;
//fp=fopen("text.txt","w");
