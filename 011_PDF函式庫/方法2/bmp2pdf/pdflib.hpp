...
// $Id: pdflib.hpp,v 1.46.2.3 2005/06/08 19:59:01 tm Exp $
//
...
void PDFlib::setlinejoin(int linejoin) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_setlinejoin(p, linejoin);
    PDFCPP_CATCH;
}

void PDFlib::setlinewidth(double width) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_setlinewidth(p, width);
    PDFCPP_CATCH;
}

void PDFlib::setmatrix( double a, double b, double c, double d, double e, double f)
    throw(PDFlib::Exception)
{
...
void PDFlib::setmiterlimit(double miter) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_setmiterlimit(p, miter);
    PDFCPP_CATCH;
}

void PDFlib::setpolydash(float *darray, int length) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_setpolydash(p, darray, length);
    PDFCPP_CATCH;
}

int PDFlib::shading (string shtype, double x0, double y0, double x1, double y1,
    double c1, double c2, double c3, double c4, string optlist)
    throw(PDFlib::Exception)
{
    int retval = 0;
...
int PDFlib::shading_pattern (int shade, string optlist) throw(PDFlib::Exception)
{
    int retval = 0;
...
void PDFlib::shfill (int shade) throw(PDFlib::Exception)
{
    PDFCPP_TRY
...
void PDFlib::show(string text) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_show2(p, CHAR(text), (int) LEN(text));
    PDFCPP_CATCH;
}

int PDFlib::show_boxed(string text, double left, double top,
    double width, double height, string hmode, string feature)
    throw(PDFlib::Exception)
{
    int retval = 0;
...
void PDFlib::show_xy(string text, double x, double y) throw(PDFlib::Exception)
{
    PDFCPP_TRY
...
void PDFlib::skew(double alpha, double beta) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_skew(p, alpha, beta);
    PDFCPP_CATCH;
}

double PDFlib::stringwidth(string text, int font, double fontsize)
    throw(PDFlib::Exception)
{
    double retval = 0;
...
void PDFlib::stroke() throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_stroke(p);
    PDFCPP_CATCH;
}

void PDFlib::suspend_page(string optlist)
    throw(PDFlib::Exception)
{
    PDFCPP_TRY
...
void PDFlib::translate(double tx, double ty) throw(PDFlib::Exception)
{
    PDFCPP_TRY	m_PDFlib_api->PDF_translate(p, tx, ty);
    PDFCPP_CATCH;
}

string PDFlib::utf16_to_utf8(string utf16string) throw(PDFlib::Exception)
{
    const char *retval = NULL;
...
string PDFlib::utf8_to_utf16(string utf8string, string format) throw(PDFlib::Exception)
{
    const char *retval = NULL;
...
void PDFlib::xshow(string text, const double *xadvancelist) throw(PDFlib::Exception)
{
