...
setenv MYCFLAGS '-fast -xO3 -xtarget=generic'
./configure
...
External versions of these libraries are not required and not supported.
...
libs without any name conflicts.
...
5.0.4     4:2:2   maintenance release
6.0.0     5:0:0   major release, added and removed API functions
6.0.1     5:1:0   maintenance release
6.0.2     5:2:0   maintenance release
6.0.3     5:3:0   maintenance release
...
We also use CURRENT and REVISION for numbering the Apple Mac OS X Frameworks
for our products.

CURRENT is used for "Framework Version"
REVISION is used for "Compatibility Version" and "Current version"
