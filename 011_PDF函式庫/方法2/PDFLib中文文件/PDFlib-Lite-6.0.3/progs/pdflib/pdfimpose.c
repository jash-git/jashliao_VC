...
/* $Id: pdfimpose.c,v 1.17.2.3 2005/06/08 19:59:04 tm Exp $
 *
...
usage(void)
{
    ...
    fprintf(stderr,
	"(c) PDFlib GmbH and Thomas Merz 2001-2005 www.pdflib.com\n\n");
...
main(int argc, char *argv[])
{
	...
	if (rows == 1 && cols == 1) {
		...
		sprintf(optlist, "boxsize {%d %d} position 0 fitmethod meet",
			colwidth, rowheight);
		*/
		sprintf(optlist, "scale %f", scale);
