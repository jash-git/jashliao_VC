...
in the PDF file PDFlib-manual.pdf. A separate edition of the manual is
available for COM, .NET, and REALbasic.
...
- PDFlib Lite
  ...
  The differences are detailed in the PDFlib manual.
...
Copyright (c) 1997-2006 PDFlib GmbH and Thomas Merz.  All rights reserved.
