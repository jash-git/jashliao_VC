/* PDFlib GmbH cvsid: $Id: tiffiop.h,v 1.12.2.2 2005/08/08 20:14:03 tm Exp $ */
...
struct tiff {
	...
	FILE*		tif_fd;		/* open file descriptor */
...
/* tag support */
	...
	/* PDFlib GmbH: inserted for bugfix from libtiff 3.7.0 */
	const TIFFFieldInfo *tif_foundfield;/* cached pointer to already
						found tag */
...
#define	SeekOK(tif, off) \
	(TIFFSeekFile(tif, (toff_t) off, SEEK_SET) != (toff_t) -1)
#endif
#ifndef WriteOK
...
extern "C" {
#endif
extern  int PDFlibEncodeError(TIFF*, tidata_t, tsize_t, tsample_t);
...
extern	void _TIFFsetByteArray(TIFF*, void**, void*, long);
extern	void _TIFFsetString(TIFF*, char**, char*);
extern	void _TIFFsetShortArray(TIFF*, uint16**, uint16*, long);
extern	void _TIFFsetLongArray(TIFF*, uint32**, uint32*, long);
extern	void _TIFFsetFloatArray(TIFF*, float**, float*, long);
