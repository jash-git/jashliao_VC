...
/* $Id: pc_font.h,v 1.70.2.12 2005/11/09 21:05:08 kurt Exp $
 *
...
struct pdc_font_s {
    ...
    int         metricflags;            /* flags for estimated font values */
...
#define PDC_MISSING_FONTVAL  PDC_SHRT_MIN     /* missing font value */
