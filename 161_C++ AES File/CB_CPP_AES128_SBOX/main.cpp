...
static void test_encrypt_ecb_verbose1(void);//jash.liao add
...
int main()
{
    ...
    test_encrypt_ecb_verbose1();//jash.liao add
...
static void test_encrypt_ecb_verbose1(void)//jash.liao add
{
    ...
    uint8_t key[16] =        { (uint8_t) 0x36, (uint8_t) 0x64, (uint8_t) 0x9A, (uint8_t) 0xF2, (uint8_t) 0x6D, (uint8_t) 0xDE, (uint8_t) 0x0C, (uint8_t) 0x3A, (uint8_t) 0x0F, (uint8_t) 0x1E, (uint8_t) 0x2D, (uint8_t) 0x3C, (uint8_t) 0x4B, (uint8_t) 0x5A, (uint8_t) 0x69, (uint8_t) 0x78 };

    uint8_t plain_text[16] = { (uint8_t) 0xAA, (uint8_t) 0x55, (uint8_t) 0xBB, (uint8_t) 0x66,
                               (uint8_t) 0x00, (uint8_t) 0x02, (uint8_t) 0x00, (uint8_t) 0x00,
    ...
    printf("plain text:\n");
    for(i = (uint8_t) 0; i < (uint8_t) 1; ++i)//4->1
    {
