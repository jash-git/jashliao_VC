...
void SetSeconds()
{
	...
	_outp(0x2f, 0x08);  //2 minute change to 0x08 for set minute
};
//
void SetBaseTime()
{
	...
	_outp(0x2f, 0x02);//_outp(0x2f, 0x08);  //2 minute change to 0x08 for set minute
};
//
void ResetWDT()
{
