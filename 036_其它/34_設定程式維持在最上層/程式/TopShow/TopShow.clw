...
NewFileInclude2=#include "TopShow.h"
LastPage=0
...
[CLS:CTopShowApp]
Type=0
HeaderFile=TopShow.h
ImplementationFile=TopShow.cpp
Filter=N

[CLS:CTopShowDoc]
Type=0
HeaderFile=TopShowDoc.h
ImplementationFile=TopShowDoc.cpp
Filter=N

[CLS:CTopShowView]
Type=0
HeaderFile=TopShowView.h
ImplementationFile=TopShowView.cpp
Filter=C
