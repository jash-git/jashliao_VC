...
void CTest123View::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CTest123View::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	// TODO: Add your message handler code here and/or call default
	...
	CMainFrame *f1=(CMainFrame *)AfxGetMainWnd();
	f1->SetWindowPos(NULL,0,0,250+number,150+number,SWP_NOZORDER);
