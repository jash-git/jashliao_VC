...
BEGIN_MESSAGE_MAP(CMonitor_SleepApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMonitor_SleepApp 建構

CMonitor_SleepApp::CMonitor_SleepApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMonitor_SleepApp 物件

CMonitor_SleepApp theApp;


// CMonitor_SleepApp 初始設定

BOOL CMonitor_SleepApp::InitInstance()
{
