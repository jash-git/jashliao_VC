...
struct file_data
{
	...
	int intstatus;
	char chrNetDir[50];//2008/10/22 jash.liao write_SAVE: AV OR Data
...
FILE *pfAction;//補砍檔全記錄//2008/10/23 jash.liao write
/////////////////////////////////////////////////////////////////////////////
...
void CTest_Analyse_DataDlg::OnButton1() 
{
	...
	CString StrNetDir;//2008/10/22 jash.liao write
	...
	//********************************************************
	CTime t1=CTime::GetCurrentTime();//2008/10/23 jash.liao write
	CString StrActionFileName,StrActionBuf;//2008/10/23 jash.liao write
	StrActionFileName=t1.Format( "%Y%m%d" );//2008/10/23 jash.liao write
	StrActionFileName="Log\\Action_"+StrActionFileName;//2008/10/23 jash.liao write
	StrActionFileName+=".txt";//2008/10/23 jash.liao write
	pfAction=fopen(StrActionFileName.GetBuffer(0),"w");//2008/10/23 jash.liao write
	//**********************************************************
	int intCount=0;
	////////////////////////取得目前路徑
	TCHAR strCurDrt[500];
	...
	//////////////////////////////01_end
	{
		...
		do
		{
			...
			switch(intCount)
			{
				...
				case 4://file_path
					...
					break;
				case 5://status
					fd.intstatus=0;//2008/10/22 jash.liao write
					strcpy(fd.chrNetDir,chrOutBuf);//2008/10/22 jash.liao write
					StrNetDir=fd.chrNetDir;//2008/10/22 jash.liao write
					break;
				case 6://Start_Data
		...
		if(StrIP!=StrBuf)
		{
			...
			{//連線
				...
				if(gblnConnectCheck)//2008/10/23 jash.liao write
				{//2008/10/23 jash.liao write
					//***********************************************
					t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
					StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
					StrActionBuf+=";;Connect success;;";//2008/10/23 jash.liao write
					StrActionBuf+=StrIP;//2008/10/23 jash.liao write
					fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
					//*********************************************** 
				}//2008/10/23 jash.liao write
				else//2008/10/23 jash.liao write
				{//2008/10/23 jash.liao write
					//***********************************************
					t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
					StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
					StrActionBuf+=";;Connect faill;;";//2008/10/23 jash.liao write
					StrActionBuf+=StrIP;//2008/10/23 jash.liao write
					fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
					//*********************************************** 
				}//2008/10/23 jash.liao write
			...
			{//斷線&連線
				...
				if(rslt!=0)
				{
					//MessageBox("無法中斷網路磁碟機");//2008/10/23 jash.liao write
					//return;//2008/10/23 jash.liao write
					//***********************************************
					t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
					StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
					StrActionBuf+=";;Disconnect faill;;";//2008/10/23 jash.liao write
					StrActionBuf+=StrIP;//2008/10/23 jash.liao write
					fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
					//***********************************************
					fclose(pfAction);//2008/10/23 jash.liao write
					this->OnOK();  //2008/10/23 jash.liao write
				}
				else
				{
					//***********************************************
					t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
					StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
					StrActionBuf+=";;Disconnect success;;";//2008/10/23 jash.liao write
					StrActionBuf+=StrIP;//2008/10/23 jash.liao write
					fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
					//*********************************************** 
					CreateNetWorkPath();//產生連線網址
			...
			StrFileName="OutPutDir\\";//2008/10/22 jash.liao write
			StrFileName=StrFileName+chrFileName;//2008/10/22 jash.liao write
			StrFileName+=".txt";
		...
		if(StrNetDir=="AV")//2008/10/22 jash.liao write
		{//2008/10/22 jash.liao write
			StrNetWorkDir="X:\\AV\\";//2008/10/22 jash.liao write
		}//2008/10/22 jash.liao write
		else//2008/10/22 jash.liao write
		{//2008/10/22 jash.liao write
			StrNetWorkDir="X:\\Data\\";//2008/10/22 jash.liao write
		}//2008/10/22 jash.liao write
		...
		if(StrNetDir=="AV")//2008/10/22 jash.liao write
		{//2008/10/22 jash.liao write
			StrInfoFileName="X:\\AV\\Schedule\\";//2008/10/22 jash.liao write
		}//2008/10/22 jash.liao write
		else//2008/10/22 jash.liao write
		{//2008/10/22 jash.liao write
			StrInfoFileName="X:\\Data\\Schedule\\";//2008/10/22 jash.liao write
		}//2008/10/22 jash.liao write
			...
			switch(fd.intaction)
			{
				case 0://Add
					if(blnSearchFile==true)
					{
						...
						t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
						StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
						StrActionBuf+=";;Don't Add;;";//2008/10/23 jash.liao write
						StrActionBuf+=StrDir;//2008/10/23 jash.liao write
						fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
						//*********************************************** 
					}
					else
					{
						if(CopyFile(StrDir.GetBuffer(0),StrNetWorkFile.GetBuffer(0),FALSE))
						{
							...
							t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
							StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
							StrActionBuf+=";;Add File success;;";//2008/10/23 jash.liao write
							StrActionBuf+=StrDir;//2008/10/23 jash.liao write
							fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
							//*********************************************** 
						}
						else
						{
							...
							t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
							StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
							StrActionBuf+=";;Add File faill;;";//2008/10/23 jash.liao write
							StrActionBuf+=StrDir;//2008/10/23 jash.liao write
							fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
							//*********************************************** 
						}
				...
				case 1://Del
					if(blnSearchFile==true)
					{
						if(DeleteFile(StrNetWorkFile.GetBuffer(0)))
						{
							...
							t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
							StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
							StrActionBuf+=";;Delete File success;;";//2008/10/23 jash.liao write
							StrActionBuf+=StrDir;//2008/10/23 jash.liao write
							fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
							//*********************************************** 
						}
						else
						{
							...
							t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
							StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
							StrActionBuf+=";;Delete File faill;;";//2008/10/23 jash.liao write
							StrActionBuf+=StrDir;//2008/10/23 jash.liao write
							fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
							//*********************************************** 
						}
					...
					else
					{
						...
						t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
						StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
						StrActionBuf+=";;Don't Delete;;";//2008/10/23 jash.liao write
						StrActionBuf+=StrDir;//2008/10/23 jash.liao write
						fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
						//*********************************************** 
					}
				...
				case 2://Check
					if(blnSearchFile==true)
					{
						...
						t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
						StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
						StrActionBuf+=";;Check OK;;";//2008/10/23 jash.liao write
						StrActionBuf+=StrDir;//2008/10/23 jash.liao write
						fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
						//*********************************************** 
					}
					else
					{
						...
						t1=t1.GetCurrentTime();//2008/10/23 jash.liao write
						StrActionBuf=t1.Format("%Y%m%d%H%M%S");//2008/10/23 jash.liao write
						StrActionBuf+=";;Check NOt OK;;";//2008/10/23 jash.liao write
						StrActionBuf+=StrDir;//2008/10/23 jash.liao write
						fprintf(pfAction,"%s\n",StrActionBuf.GetBuffer(0));//2008/10/23 jash.liao write
						//*********************************************** 
					}
...
void CTest_Analyse_DataDlg::OnTimer(UINT nIDEvent) 
{
