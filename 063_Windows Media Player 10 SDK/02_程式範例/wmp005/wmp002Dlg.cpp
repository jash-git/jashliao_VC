...
BOOL CWmp002Dlg::OnInitDialog()
{
	...
	//this->SetWindowPos(NULL,0,0,320,240,0); 
	...
	CString Strfilename;
	CWMPMedia newMedia1,newMedia2,newMedia3;
	CFileDialog fdlg(true,NULL,"",NULL,"MySQL連結設定檔|*.rmvb"); 
	if(fdlg.DoModal()==IDOK)
	{
		Strfilename=fdlg.GetPathName();
		newMedia1=m_WMP.newMedia(Strfilename);
	}
	if(fdlg.DoModal()==IDOK)
	{
		Strfilename=fdlg.GetPathName();
		newMedia2=m_WMP.newMedia(Strfilename);
	}
	if(fdlg.DoModal()==IDOK)
	{
		Strfilename=fdlg.GetPathName();
		newMedia3=m_WMP.newMedia(Strfilename);
	}
	//CWMPMedia newMedia2=m_WMP.newMedia("D:\\02.rmvb");
	//CWMPMedia newMedia3=m_WMP.newMedia("D:\\03.rmvb");
