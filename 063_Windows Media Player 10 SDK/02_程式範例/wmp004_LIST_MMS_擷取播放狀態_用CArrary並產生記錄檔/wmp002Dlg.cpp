...
BOOL CWmp002Dlg::OnInitDialog()
{
	...
	///*
	gStrMMSArrBuf[0]="mms://mms.iptv.tw-airnet.net/mms3/movies/M00395.wmv";
	gStrMMSArrBuf[1]="mms://mms.iptv.tw-airnet.net/mms3/movies/M1258.wmv";
	gStrMMSArrBuf[2]="mms://mms.iptv.tw-airnet.net/mms3/movies/M210.wmv";
	gStrMMSArrBuf[3]="mms://dtv.iptv.tw-airnet.net/DTV-195";
	gStrMMSArrBuf[4]="mms://dtv.iptv.tw-airnet.net/DTV-196";
	gStrMMSArrBuf[5]="mms://dtv.iptv.tw-airnet.net/DTV-197";
	gStrMMSArrBuf[6]="mms://dtv.iptv.tw-airnet.net/DTV-198";
	gStrMMSArrBuf[7]="mms://dtv.iptv.tw-airnet.net/DTV-199";
	gStrMMSArrBuf[8]="mms://dtv.iptv.tw-airnet.net/DTV-200";
	gStrMMSArrBuf[9]="mms://dtv.iptv.tw-airnet.net/DTV-201";
	m_MMSArray.RemoveAll();
	m_MMSArray.Add(gStrMMSArrBuf[0]);
	m_MMSArray.Add(gStrMMSArrBuf[1]);
	m_MMSArray.Add(gStrMMSArrBuf[2]);
	m_MMSArray.Add(gStrMMSArrBuf[3]);
	m_MMSArray.Add(gStrMMSArrBuf[4]);
	m_MMSArray.Add(gStrMMSArrBuf[5]);
	m_MMSArray.Add(gStrMMSArrBuf[6]);
	m_MMSArray.Add(gStrMMSArrBuf[7]);
	m_MMSArray.Add(gStrMMSArrBuf[8]);
	m_MMSArray.Add(gStrMMSArrBuf[9]);
	//*/
	/*
	...
	*/
	...
	CString StrFileName;
	StrFileName=t1.Format("%Y%m%d%H%M%Slogs.txt");
