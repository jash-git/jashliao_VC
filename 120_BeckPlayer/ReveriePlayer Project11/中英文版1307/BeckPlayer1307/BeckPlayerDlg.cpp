		...
		*/
		 switch(gintStep)
		 {
		  ...
		  case 3://-foot vibration (6)
		   ...
		   break;
		  case 4://-foot vibration (6)
			//-您的腰也開始享受到舒服的按摩
			if(flttime>99 && flttime<100)
			{
				StepControl16();
				m_V3.Format("%d",gintStep);
				gintStep=5;
		   ...
		   break;
		  case 5://-foot vibration (6)
			//-您的腰也開始享受到舒服的按摩
			if(flttime>105 && flttime<106)
			{
				StepControl17();
				m_V3.Format("%d",gintStep);
				gintStep=6;
		   ...
		   break;
		  case 6://-foot vibration (10)
			//-同時，您的雙腳不再有任何緊繃感
			if(flttime>110 && flttime<111)
			{
				StepControl03();
				m_V3.Format("%d",gintStep);
				gintStep=7;
		   ...
		   break;
		  case 7://head position (30)
			//-現在, 您的身體即將進入  最輕鬆的零重力狀態
			if(flttime>133 && flttime<134)
			{
				StepControl04();
				m_V3.Format("%d",gintStep);
				gintStep=8;
		   ...
		   break;
		  case 8://-Head vibration (1)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>147 && flttime<148)
			{
				StepControl05();
				m_V3.Format("%d",gintStep);
				gintStep=9;
		   ...
		   break;
		  case 9://-Head vibration (2)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>170 && flttime<171)
			{
				StepControl06();
				m_V3.Format("%d",gintStep);
				gintStep=10;
		   ...
		   break;
		  case 10://-Head vibration (3)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>178 && flttime<179)
			{
				StepControl07();
				m_V3.Format("%d",gintStep);
				gintStep=11;
		   ...
		   break;
		  case 11://-Head vibration (4)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>186 && flttime<187)
			{
				StepControl08();
				m_V3.Format("%d",gintStep);
				gintStep=12;
		   ...
		   break;
		  case 12://-Head vibration (5)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>194 && flttime<195)
			{
				StepControl09();
				m_V3.Format("%d",gintStep);
				gintStep=13;
		   ...
		   break;
		  case 13://-Head vibration (6)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>202 && flttime<203)
			{
				StepControl10();
				m_V3.Format("%d",gintStep);
				gintStep=14;
		   ...
		   break;	
		  case 14://-Head vibration (7)
			//-這種姿勢與背部的按摩感覺 彷彿母親輕拍您的背
				//安撫您入睡 這是一種安全感 更是一份幸福感
			if(flttime>210 && flttime<211)
			{
				StepControl11();
				m_V3.Format("%d",gintStep);
				gintStep=15;
		   ...
		   break;
		  case 15://-foot position(0)
			//據統計, 現代成年人近6成都有睡覺打呼的困擾
			if(flttime>218 && flttime<219)
			{
				StepControl12();
				m_V3.Format("%d",gintStep);
				gintStep=16;
			}
		  case 16://-head position(13)
			//據統計, 現代成年人近6成都有睡覺打呼的困擾
			if(flttime>227 && flttime<228)
			{
				StepControl14();
				m_V3.Format("%d",gintStep);
				gintStep=17;
			}
		  case 17://Memory function(1)
			//-經過了一夜的舒眠，您的身體已經再次充滿能量，肌肉也可以進入戰鬥狀態
			if(flttime>237 && flttime<238)
			{
				StepControl13();
				m_V3.Format("%d",gintStep);
				gintStep=18;
		   ...
		   break;
		  case 18://Memory function(1)
			//-經過了一夜的舒眠，您的身體已經再次充滿能量，肌肉也可以進入戰鬥狀態
			if(flttime>323 && flttime<324)
			{
				StepControl15();
				m_V3.Format("%d",gintStep);
				gintStep=19;
...
void CBeckPlayerDlg::StepControl16()
{
	char buf[4];
	buf[0]=35;//#
	buf[1]=83;//S
	...
	if(blnopenRS485)
	{
		...
		MessageBox("16_Not Open RS485");	
}
void CBeckPlayerDlg::StepControl17()
{
	char buf[4];
	buf[0]=35;//#
	buf[1]=83;//S
