...
void CMainFrame::OnButton1() 
{
	...
	char chData3[100];
	int intdata3;
	CWnd *pEdit1=m_wndMyDialogBar.GetDlgItem(IDC_EDIT1);
	CWnd *pEdit2=m_wndMyDialogBar.GetDlgItem(IDC_EDIT2);
	CWnd *pEdit3=m_wndMyDialogBar.GetDlgItem(IDC_EDIT3);
	pEdit1->GetWindowText(str1);
	chData1=str1.GetBuffer(0);
	intdata1=atoi(chData1);
	pEdit2->GetWindowText(str1);
	chData2=str1.GetBuffer(0);
	intdata2=atoi(chData2);
	intdata3=intdata2+intdata1;
	itoa(intdata3,chData3,10);
	str1=chData3;
	pEdit3->SetWindowText(str1); 
}
