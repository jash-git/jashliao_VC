...
///////////////////////////////////////////
	glPushMatrix();///區塊start
	{
		...
		//drawRetc(float W,float L,float H)
		...
		glPushMatrix();///區塊start
		{
			...
			drawRetc(100.0f,100.0f,200.0f);//
			glRotatef(Rotat1, 0.0f, 0.0f, 1.0f);//視角旋轉角度
			glPushMatrix();///區塊start
			{
				glColor3ub(130.0f,0.0f,130.0f);
				glTranslatef(100.0f/2.0f-300.0f/2.0f,0.0f,200.0f/2.0f+100.0f/2.0f);
				drawRetc(300.0f,100.0f,100.0f);
				////////////////////////////////////
				glTranslatef(-200.0f/2.0f,0.0f,0.0f);
				glRotatef(Rotat2, 0.0f, 0.0f, 1.0f);//視角旋轉角度
				glTranslatef(200.0f/2.0f,0.0f,0.0f);
				//////////////////////////////////////
				glPushMatrix();///區塊start
				{
					glColor3ub(130.0f,130.0f,0.0f);
					glTranslatef(-300.0f/2.0f-300.0f/2.0f+100.0f,0.0f,100.0f/-2.0f-100.0f/2.0f);
					drawRetc(300.0f,100.0f,100.0f);
					glPushMatrix();///區塊start
					{
						glColor3ub(50.0f,130.0f,0.0f);
						glTranslatef(-300.0f/2.0f+20.0f,0.0f,100.0f/-2.0f-(50.0f+Trans1)/2.0f);
						//drawCir(float radius, float L, int segment)
						drawCir(20.0f,50.0f+Trans1,16);
					}
					glPopMatrix();///區塊end
				}
				glPopMatrix();///區塊end
