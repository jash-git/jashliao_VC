...
document.write("<scr"+"ipt src='https://g.csdnimg.cn/notification/1.3.5/notify.js'></scr"+"ipt>");
document.write("<scr"+"ipt src='https://g.csdnimg.cn/notification/1.3.5/main.js'></scr"+"ipt>");
var _gaq = [];
        ...
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="gitChat upload"><a class="" href="https://msg.csdn.net/" target="_blank"><img src="https://csdnimg.cn/public/common/toolbar/images/message-icon.png" alt="" class="message"><span>消息</span><div class="toolbar-circle"></div></a></li>\
