...
//*   Date   *                                                     *   Who   *
//****************************************************************************
//* 12/5/2002* Created source file.                                *   CLR   *
//****************************************************************************
#include "stdafx.h"
...
/*                                                                          */
/****************************************************************************/
int QTiff::open( char* szTiff, char * szMode ) 
{
  char szM[ 10 ];
...
void * QTiff::Create( DWORD a_dwWidth, DWORD a_dwHeight, long a_wBpp )
{
  //
...
void QTiff::SetPaletteIndex(BYTE idx, BYTE r, BYTE g, BYTE b, BYTE alpha)
{
	if ((m_pDib) && (m_head.biClrUsed)) {
...
int QTiff::FillColorMap( QT_COLOR_MAP * colors )
{
