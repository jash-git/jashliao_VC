...
// SMS_TCP_Client.cpp : 定義應用程式的類別行為。
//
...
BEGIN_MESSAGE_MAP(CSMS_TCP_ClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSMS_TCP_ClientApp 建構

CSMS_TCP_ClientApp::CSMS_TCP_ClientApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CSMS_TCP_ClientApp 物件

CSMS_TCP_ClientApp theApp;


// CSMS_TCP_ClientApp 初始設定

BOOL CSMS_TCP_ClientApp::InitInstance()
{
