...
void CSetValueDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CSetValueDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CSetValueDlg::OnButton1() 
{
...
void CSetValueDlg::OnButton2() 
{
	// TODO: Add your control notification handler code here
	SetTimer(1,10,NULL);	
}

void CSetValueDlg::OnTimer(UINT nIDEvent) 
{
	...
	double in;
	UpdateData(true);
		out=0.1*sin(data/180*3.1415926);
		m_v3=out;
	UpdateData(false);
	mapView = MapViewOfFile( hFileMap[2],FILE_MAP_WRITE, 0, 0, 0 ) ;
	GetDlgItemText(IDC_EDIT3,(LPTSTR)mapView,20);
