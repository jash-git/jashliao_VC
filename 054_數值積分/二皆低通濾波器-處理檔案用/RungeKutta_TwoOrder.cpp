// RungeKutta_TwoOrder.cpp: implementation of the RungeKutta_TwoOrder class.
//
//////////////////////////////////////////////////////////////////////
...
void RungeKutta_TwoOrder::calculate(void)
{
	...
	Y=X1+(delT*(K1X1p+(2.0f*(K2X1p+K3X1p))+K4X1p)/6.0f);
	Y1=X2+(delT*(K1X2p+(2.0f*(K2X2p+K3X2p))+K4X2p)/6.0f);
	/////////////////////////////////////////////////////
}
