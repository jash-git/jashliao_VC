...
{
    var txtBox = document.getElementById('search_txtSearch');
    if(txtBox)
    {
        window.open('http://www.google.com/search?q=' + txtBox.value + '&ie=UTF8&oe=UTF8&hl=zh-TW&btnG=Search&domains='+ url +'&sitesearch=' + url);
    }
}