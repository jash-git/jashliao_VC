================================================================================
    MFC 程式庫 : VS2010_MFC_UAC 專案概觀
===============================================================================

應用程式精靈已經為您建立了這個 VS2010_MFC_UAC 應用程式。這個應用程式
不僅示範了使用 MFC 的基本概念，也是您撰寫應用程式的起點。

這個檔案的內容摘要，包含各個構成 VS2010_MFC_UAC 應用程式的檔案。

VS2010_MFC_UAC.vcxproj
    這是使用應用程式精靈所產生之 VC++ 專案的主要專案檔。 
    它包含產生檔案時的 Visual C++ 版本資訊，以及使用應用程式精靈產生檔案的
    過程中，選取的平台、組態和專案功能的相關資訊。

VS2010_MFC_UAC.vcxproj.filters
...
VS2010_MFC_UAC.h
    ...
    並宣告 CVS2010_MFC_UACApp 應用程式類別。

VS2010_MFC_UAC.cpp
    這是主要的應用程式原始程式檔，它包含應用程式類別 CVS2010_MFC_UACApp。
...
res\VS2010_MFC_UAC.ico
    這個圖示檔是用來做為應用程式的圖示。這個圖示包含在主要資源檔
    VS2010_MFC_UAC.rc 內。

res\VS2010_MFC_UAC.rc2
...
VS2010_MFC_UACDlg.h、VS2010_MFC_UACDlg.cpp - 對話方塊
    這些檔案包含您的 CVS2010_MFC_UACDlg 類別。這個類別定義應用程式主
    對話方塊的行為。對話方塊的範本在 VS2010_MFC_UAC.rc 內，您可以 
...
StdAfx.h、StdAfx.cpp
    這些檔案是用來建置名為 VS2010_MFC_UAC.pch 的先行編譯標頭 (PCH) 檔，
