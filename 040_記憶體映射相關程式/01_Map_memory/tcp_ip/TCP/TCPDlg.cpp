...
void CTCPDlg::OnCreate() 
{
	// TODO: Add your control notification handler code here
	/*
	sockListen.Create(6802,SOCK_STREAM,"140.134.32.71");
	sockListen.Bind(6801,"140.134.32.71");
	sockListen.Listen(5);
	sockListen.Accept(m_sockSend);
	*/
	ls.Create(6801,SOCK_STREAM,"192.168.31.13");
	ls.Bind(6801,"192.168.31.13");
	
}

void CTCPDlg::OnListen() 
{
	// TODO: Add your control notification handler code here
	ls.Listen(5);
}
