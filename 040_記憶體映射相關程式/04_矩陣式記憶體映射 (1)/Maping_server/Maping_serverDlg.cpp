	...
	: CDialog(CMaping_serverDlg::IDD, pParent)
{
	...
	m_v4 = 0.0;
	//}}AFX_DATA_INIT
//	char *MAP_NAME[20]={"spacesoft1 corp0.","spacesoft1 corp1.","spacesoft1 corp3.","spacesoft1 corp4."};
	char *MAP_NAME[20];
	...
	/*
	hFileMap[0] = CreateFileMapping( (HANDLE)0xFFFFFFFF,NULL, PAGE_READWRITE, 0, MAP_LENGTH, MAP_NAME[0] ) ;
	hFileMap[1] = CreateFileMapping( (HANDLE)0xFFFFFFFF,NULL, PAGE_READWRITE, 0, MAP_LENGTH, MAP_NAME[1] ) ;
	hFileMap[2] = CreateFileMapping( (HANDLE)0xFFFFFFFF,NULL, PAGE_READWRITE, 0, MAP_LENGTH, MAP_NAME[2] ) ;
	hFileMap[3] = CreateFileMapping( (HANDLE)0xFFFFFFFF,NULL, PAGE_READWRITE, 0, MAP_LENGTH, MAP_NAME[3] ) ;
	*/
