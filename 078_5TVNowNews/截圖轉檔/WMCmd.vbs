	...
	for i=0 to UBound(args)
		...
		select case LCase( args(i) )
			...
			case "-a_codec"
				...
				if g_strAudioCodec <> WMA9STD and g_strAudioCodec <> WMA9PRO and g_strAudioCodec <> WMA9LSL and g_strAudioCodec <> PCM then
			...
			case "-v_codec"
				...
				if g_strVideoCodec <> WMV7 and g_strVideoCodec <> WMV8 and g_strVideoCodec <> WMV9 and g_strVideoCodec <> WMS9 and g_strVideoCodec <> UNCOMP and g_strVideoCodec <> WMVA then
...
function ShowHelp()
	...
	OutputInfo "    WMA9STD: Windows Media Audio 9.1 (default)."
	OutputInfo "    WMA9PRO: Windows Media Audio 9.1 Professional"
	OutputInfo "    WMA9LSL: Windows Media Audio 9.1 Lossless; -a_mode 2 required"
	...
	OutputInfo "       WMVA: Windows Media Video 9 Advanced Profile."
...
function CheckForValidAudioBitRates( intBitRate )
	...
	select case intBitRate
		...
		case 1411200,768000,705600,640000,440000,384000,383000,352800,320000,256000,255000,192000,191000,160000,128000,127000,96000,95000,80000,_
			 64000,63000,48000,40000,32000,22000,20000,17000,16000,12000,10000,8000,6000,5000,4000,0
