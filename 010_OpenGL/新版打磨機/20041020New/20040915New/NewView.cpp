...
void CNewView::BaseX_model()//X軸底座
{
	///////////////////////////////////////////////
	////X軸start
	//glTranslatef(shiftXValue+((Base_W4-X_Base_W1)/2.0f)-(X_Base_W4-X_Base_W3)/2.0f/*賦予生命*/,((Base_L1/2.0f-X_Base_L1/2.0f+shift_7+X_Base_L3/2.0f)-(shift_1+shift_3+Base_L4/2.0f)),(Base_H1/2.0f+Base_H3+Base_H4/2.0f)+(X_Base_H1/2.0f+X_Base_H3+shift_10-X_Base_H5/2.0f));//放在右邊
