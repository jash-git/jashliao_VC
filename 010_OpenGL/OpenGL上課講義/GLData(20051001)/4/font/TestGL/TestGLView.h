...
protected:
	double Text3DScaleX,Text3DScaleY,Text3DScaleZ;
	int CountCharacter();
	unsigned short* Text3DIndex;
	GLYPHMETRICSFLOAT *Text3Dgmf;
	int Text3DLen;
	GLuint Text3DList;
	CString Text3DStr;
	void Create3DText(char *str,double width,double height,double thickness);
	void Out3DText(double x,double y,double z);
	//{{AFX_MSG(CTestGLView)
