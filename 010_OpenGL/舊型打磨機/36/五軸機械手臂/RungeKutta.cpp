...
RungeKutta::RungeKutta(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j, double k, double l, double m, double t)
{
	////////////////////////////////////////
	delT = t;
	A = a; B = b; C = c; D = d; E = e; F = f; G = g;
...
void RungeKutta::Compute(double u1, double u2, double u3, double u4, double u5, double u6)
{
	...
	XX1p = x1+(delT/2.0)*K3X1p;
	XX2p = x2+(delT/2.0)*K3X2p;
	XX3p = x3+(delT/2.0)*K3X3p;
	XX4p = x4+(delT/2.0)*K3X4p;
	XX5p = x5+(delT/2.0)*K3X5p;
	XX6p = x6+(delT/2.0)*K3X6p;
