// timer1Dlg.cpp : implementation file
//
...
void CTimer1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CTimer1Dlg::OnTimer(UINT nIDEvent) 
{
	...
	LPVOID mapView1 = MapViewOfFile( hFileMap1,FILE_MAP_WRITE, 0, 0, 0 ) ;
	if( mapView != NULL ) 
	{
		//GetDlgItemText( IDC_EDIT1,(LPTSTR)mapView, MAP_LENGTH ) ;
		//GetDlgItemText( IDC_EDIT2,(LPTSTR)mapView1, MAP_LENGTH ) ;
		//GetDlgItemText( IDC_EDIT2,(LPTSTR)mapView, MAP_LENGTH ) ;
		
		itoa(m_a,((LPTSTR)mapView),10);
		itoa(m_b,((LPTSTR)mapView1),10);
