...
#endif
#define WM_MY_TRAY_NOTIFICATION WM_USER+0//step 4
/////////////////////////////////////////////////////////////////////////////
// CMainFrame
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_MESSAGE(WM_MY_TRAY_NOTIFICATION, OnTrayNotification)//step 8
	ON_WM_CREATE()
	ON_WM_CLOSE()
...
CMainFrame::CMainFrame(): m_trayIcon(IDR_MENU1)//step 3
{
...
void CMainFrame::OnClose() //step 6
{
...
void CMainFrame::OnAppOpen() //step 12
{
...
void CMainFrame::OnAppSuspend() //step 13
{
	// TODO: Add your command handler code here
