...
void CCTime2CStrungDlg::OnButton2() 
{
	// TODO: Add your control notification handler code here
CString StrStartTime="2004-07-01";
CString StrEndTime="2004-07-19";
CTime   cTomorrow=CTime::GetCurrentTime()+CTimeSpan(1,0,0,0); 
CTime   cYestodayOnceMore=CTime::GetCurrentTime()-CTimeSpan(1,0,0,0); 	
StrStartTime=cTomorrow.Format( "%Y-%m-%d-%A" );
StrEndTime=cYestodayOnceMore.Format( "%Y-%m-%d-%A" );
}
