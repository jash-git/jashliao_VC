========================================================================
    主控台應用程式：CString2CTime 專案概觀
========================================================================

AppWizard 已經為您建立了這個 CString2CTime 應用程式。

這個檔案包含一份摘要，
簡要說明構成您的 CString2CTime 應用程式的所有檔案，它們個別的內容。


CString2CTime.vcproj
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 CString2CTime.pch 的先行編譯標頭 (PCH) 檔，
