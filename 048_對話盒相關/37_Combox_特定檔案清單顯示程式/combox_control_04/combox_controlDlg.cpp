...
void CCombox_controlDlg::ShowData(long lngNowPage)
{
	...
	m_combox1.SetWindowText(StrShowString[0]);
	m_combox2.SetWindowText(StrShowString[1]);
	m_combox3.SetWindowText(StrShowString[2]);
	m_combox4.SetWindowText(StrShowString[3]);
	m_combox5.SetWindowText(StrShowString[4]);
	m_combox6.SetWindowText(StrShowString[5]);
	m_combox7.SetWindowText(StrShowString[6]);
	m_combox8.SetWindowText(StrShowString[7]);
}
