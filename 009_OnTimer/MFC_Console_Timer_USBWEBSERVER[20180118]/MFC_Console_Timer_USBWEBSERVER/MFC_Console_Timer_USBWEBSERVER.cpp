...
void CALLBACK TimeProc(HWND hwnd, UINT message, UINT idTimer, DWORD dwTime)
{
	...
	if ((intTimerCount % 2) == 0)//180秒判斷一次
	{
		...
		//---
		//webcheck.txt
		FILE *pfwebcheck = NULL;
		pfwebcheck = fopen("C:\\Users\\Administrator\\Desktop\\Tool\\USBWebserver_v8.6\\root\\jpv\\webcheck.txt", "r");
		if (pfwebcheck == NULL)
		{
			blncheckWebport = false;
		}
		else
		{
			blncheckWebport = true;
			fclose(pfwebcheck);
		}	
		pfwebcheck = NULL;
		...
		if (blncheckWebport)
		{
			DeleteFile(L"C:\\Users\\Administrator\\Desktop\\Tool\\USBWebserver_v8.6\\root\\jpv\\webcheck.txt");
